            ...
            <section className="paper-panel rounded-[2.4rem] px-6 py-10 md:px-10 md:py-14">
                <div className="mx-auto max-w-3xl text-center">
                    ...
                    <p className="mx-auto mt-5 max-w-2xl text-base leading-8 text-muted-foreground">
                        A {storeName} foi pensada para reunir roupas fáceis de combinar, boas fotos do produto e uma compra sem rodeios.
                    </p>
                </div>
            </section>
            ...
            <section className="py-12 md:py-16">
                <div className="grid gap-5 md:grid-cols-3">
                    {[
                        ...
                        { icon: Heart, title: "Loja organizada", desc: "Categorias, fotos e informações pensadas para facilitar a decisão de compra." },
                        { icon: Users, title: "Atendimento próximo", desc: "Contato claro, linguagem simples e suporte quando você precisar." },
                    ].map((item) => (
