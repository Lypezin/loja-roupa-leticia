        ...
        <div className="page-shell py-8 md:py-12">
            <section className="paper-panel animate-enter-soft rounded-[2.4rem] px-6 py-10 md:px-10 md:py-14">
                <div className="mx-auto max-w-3xl text-center">
                    ...
                    <p className="mx-auto mt-5 max-w-2xl text-base leading-8 text-muted-foreground">
                        A {storeName} traz uma curadoria criteriosa de peças femininas, pensando sempre na qualidade, no caimento impecável e na versatilidade que a mulher contemporânea busca.
                    </p>
                </div>
            </section>
            ...
            <section className="py-12 md:py-16">
                <div className="grid gap-5 md:grid-cols-3">
                    {[
                        { icon: Sparkles, title: "Qualidade premium", desc: "Trabalhamos com tecidos selecionados para garantir durabilidade e conforto em cada peça." },
                        { icon: Heart, title: "Curadoria cuidadosa", desc: "Cada modelo é escolhido para valorizar a beleza feminina e funcionar bem no dia a dia." },
